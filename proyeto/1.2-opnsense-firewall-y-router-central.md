...
IPv4 Subnet Mask: 255.255.255.0 (CIDR: /24)

DHCP Server: Disabled (usaremos en subinterfaces)
...
ue0: flags=8843<UP,BROADCAST,RUNNING,SIMPLEX,MULTICAST> mtu 1500
  inet 192.168.1.1 netmask 0xffffff00 broadcast 192.168.1.255
  hwaddr 00:00:5e:00:53:xx
```

***

### Subinterfaces VLAN (el corazón)
